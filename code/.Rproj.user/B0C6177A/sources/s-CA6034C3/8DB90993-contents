...
set.seed(1)
mod_1_Rsolnp_log = solnp(pars = rep(1, 41), log_lik, eqfun = function(par) par[1], eqB = 0)
save(mod_1_Rsolnp_log, file = "sol/mod_1_Rsolnp_log.RData")

load("sol/mod_1_Rsolnp.RData")
cor(exp(mod_1_Rsolnp_log$pars), mod_1_Rsolnp$pars)
plot(exp(mod_1_Rsolnp_log$pars), mod_1_Rsolnp$pars)
