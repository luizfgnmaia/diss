...
set.seed(1)
mod_2_Rsolnp_log = solnp(pars = rep(1, 43), log_lik, eqfun = function(par) par[1], eqB = 0,
                         LB = c(rep(-10, 41), 0, 0))
save(mod_2_Rsolnp_log, file = "sol/mod_2_Rsolnp_log.RData")

load("sol/mod_2_Rsolnp.RData")
cor(c(exp(mod_2_Rsolnp_log$pars[1:41]), mod_2_Rsolnp_log$pars[42:43]), mod_2_Rsolnp$pars)
plot(c(exp(mod_2_Rsolnp_log$pars[1:41]), mod_2_Rsolnp_log$pars[42:43]), mod_2_Rsolnp$pars)
