...
log_lik <- function(par) {
  ...
  #       ro_1, ro_2                                    par[66:67]
  #       lambda_10, lambda_01, lambda_21, lambda_12    par[68:71]
  #       mu_10, mu_01, mu_21, mu_12                    par[72:75]
...
set.seed(1)
sol = solnp(pars = rep(1, 75), log_lik, LB = rep(0, 75), eqfun = eqfun, eqB = n)
sol_modelo_5 = sol
save(sol_modelo_5, file = "sol/sol_modelo_5.RData")

#load("sol/sol_modelo_3.RData")
#sol = solnp(pars = c(sol_modelo_3$pars, rep(1, 8)), log_lik, LB = rep(0, 75), eqfun = eqfun, eqB = n)
#sol_modelo_5b = sol
