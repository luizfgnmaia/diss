...
colnames(J1_lambda)[41:44] = c("lambda_10", "lambda_01", "mu_10", "mu_01")
J2_lambda = cbind(J2_lambda, lambda_10_2, lambda_01_2, zero_2, zero_2)
colnames(J2_lambda)[41:44] = c("lambda_10", "lambda_01", "mu_10", "mu_01")

J1_mu = cbind(J1_mu, zero_1, zero_1, mu_10_1, mu_01_1)
colnames(J1_mu)[41:44] = c("lambda_10", "lambda_01", "mu_10", "mu_01")
J2_mu = cbind(J2_mu, zero_2, zero_2, mu_10_2, mu_01_2)
colnames(J2_mu)[41:44] = c("lambda_10", "lambda_01", "mu_10", "mu_01")
