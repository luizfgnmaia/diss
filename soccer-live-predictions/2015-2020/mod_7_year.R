...
mod_7_year = list(alpha = as.vector(c(solution$getValue(alpha))),
             ...
             duration = duration)
names(mod_7_year$alpha) = times$Time
names(mod_7_year$beta) = times$Time
names(mod_7_year$lambda_xy) = c("lambda_10", "lambda_01")
names(mod_7_year$mu_xy) = c("mu_10", "mu_01")
names(mod_7_year$omega) = "red"

save(mod_7_year, file = "2015-2020/data/mod_7_year.RData")
