---
title: "Parameters 2015-2020 model 10"
output: pdf_document
---
...
alphas_betas = tibble(Team = times$Time,
                alpha = exp(mod_10$alpha),
                beta = exp(mod_10$beta))
...
reds = tibble(Parameter, Estimative = exp(mod_10$a))
...
st = tibble(Parameter, 
            Estimative = c(mod_10$eta, mod_10$rho, mod_10$kappa))
