...
mod_7_goals = list(alpha = as.vector(c(solution$getValue(alpha))),
             ...
             duration = duration)
names(mod_7_goals$alpha) = times$Time
names(mod_7_goals$beta) = times$Time
names(mod_7_goals$lambda_xy) = c("lambda_10", "lambda_01")
names(mod_7_goals$mu_xy) = c("mu_10", "mu_01")
names(mod_7_goals$omega) = "red"

save(mod_7_goals, file = "2015-2020/data/mod_7_goals.RData")
