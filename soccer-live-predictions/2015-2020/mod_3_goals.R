...
mod_3_goals = list(alpha = as.vector(c(solution$getValue(alpha))),
                   ...
                   duration = duration)
names(mod_3_goals$alpha) = times$Time
names(mod_3_goals$beta) = times$Time
names(mod_3_goals$omega) = c("goal", "red")

save(mod_3_goals, file = "2015-2020/data/mod_3_goals.RData")
