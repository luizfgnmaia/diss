...
mod_C_year = list(alpha = as.vector(c(solution$getValue(alpha))),
                   ...
                   duration = duration)
names(mod_C_year$alpha) = times$Time
names(mod_C_year$beta) = times$Time
names(mod_C_year$omega) = "goal"

save(mod_C_year, file = "2015-2020/data/mod_C_year.RData")
