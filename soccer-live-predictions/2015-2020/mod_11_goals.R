...
load("2015-2020/data/input_mod_11.RData")
...
mod_11_goals = list(alpha = as.vector(c(solution$getValue(alpha))),
              ...
              duration = duration)
names(mod_11_goals$alpha) = times$Time
names(mod_11_goals$beta) = times$Time
names(mod_11_goals$omega) = c("goal", "red", "value")

save(mod_11_goals, file = "2015-2020/data/mod_11_goals.RData")
