...
load("2015-2020/data/input_mod_6.RData")
...
mod_6_goals = list(alpha = as.vector(c(solution$getValue(alpha))),
             ...
             duration = duration)
names(mod_6_goals$alpha) = times$Time
names(mod_6_goals$beta) = times$Time
names(mod_6_goals$lambda_xy) = c("lambda_10", "lambda_20", "lambda_01", "lambda_02")
names(mod_6_goals$mu_xy) = c("mu_10", "mu_20", "mu_01", "mu_02")
names(mod_6_goals$omega) = "red"

save(mod_6_goals, file = "2015-2020/data/mod_6_goals.RData")
