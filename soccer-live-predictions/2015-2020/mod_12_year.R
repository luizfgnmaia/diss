...
mod_12_year = list(alpha = as.vector(c(solution$getValue(alpha))),
                    ...
                    duration = duration)
names(mod_12_year$alpha) = times$Time
names(mod_12_year$beta) = times$Time
names(mod_12_year$omega) = c("goal", "red", "value")

save(mod_12_year, file = "2015-2020/data/mod_12_year.RData")
