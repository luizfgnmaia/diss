...
mod_8_year = list(alpha = as.vector(c(solution$getValue(alpha))),
                   ...
                   duration = duration)
names(mod_8_year$alpha) = times$Time
names(mod_8_year$beta) = times$Time
names(mod_8_year$omega_xy) = c("ahead", "behind")
names(mod_8_year$omega) = "red"

save(mod_8_year, file = "2015-2020/data/mod_8_year.RData")
