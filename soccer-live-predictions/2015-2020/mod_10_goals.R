...
mod_10_goals = list(alpha = as.vector(c(solution$getValue(alpha))),
                    ...
                    duration = duration)
names(mod_10_goals$alpha) = times$Time
names(mod_10_goals$beta) = times$Time
names(mod_10_goals$omega_xy) = c("ahead", "behind")
names(mod_10_goals$omega) = c("red", "value")

save(mod_10_goals, file = "2015-2020/data/mod_10_goals.RData")
