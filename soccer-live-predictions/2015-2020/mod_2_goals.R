...
mod_2_goals = list(alpha = as.vector(c(solution$getValue(alpha))),
                   ...
                   duration = duration)
names(mod_2_goals$alpha) = times$Time
names(mod_2_goals$beta) = times$Time
names(mod_2_goals$omega) = c("lambda_x-y", "mu_y-x", "lambda_ys-xs", "mu_xs-ys")

save(mod_2_goals, file = "2015-2020/data/mod_2_goals.RData")
