...
load("2015-2020/data/input_mod_4.RData")
...
mod_4_goals = list(alpha = as.vector(c(solution$getValue(alpha))),
                   ...
                   duration = duration)
names(mod_4_goals$alpha) = times$Time
names(mod_4_goals$beta) = times$Time
names(mod_4_goals$omega) = c("goal", "red", "goal^2")

save(mod_4_goals, file = "2015-2020/data/mod_4_goals.RData")
