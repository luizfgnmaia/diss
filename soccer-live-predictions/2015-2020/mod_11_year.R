...
load("2015-2020/data/input_mod_11_year.RData")
...
mod_11_year = list(alpha = as.vector(c(solution$getValue(alpha))),
                    ...
                    duration = duration)
names(mod_11_year$alpha) = times$Time
names(mod_11_year$beta) = times$Time
names(mod_11_year$omega) = c("goal", "red", "value")

save(mod_11_year, file = "2015-2020/data/mod_11_year.RData")
