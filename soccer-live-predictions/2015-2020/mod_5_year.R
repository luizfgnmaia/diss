...
load("2015-2020/data/input_mod_5_year.RData")
...
mod_5_year = list(alpha = as.vector(c(solution$getValue(alpha))),
             ...
             duration = duration)
names(mod_5_year$alpha) = times$Time
names(mod_5_year$beta) = times$Time
names(mod_5_year$lambda_xy) = c("lambda_10", "lambda_01", "lambda_11", "lambda_22", "lambda_21", "lambda_12")
names(mod_5_year$mu_xy) = c("mu_10", "mu_01", "mu_11", "mu_22", "mu_21", "mu_12")
names(mod_5_year$omega) = "red"

save(mod_5_year, file = "2015-2020/data/mod_5_year.RData")
