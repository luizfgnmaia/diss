---
title: "Parameters 2015-2020 model 7"
output: pdf_document
---
...
goals = tibble(Parameter, 
               Estimative = c(exp(mod_7$gamma), exp(mod_7$tau),
                              exp(mod_7$lambda_xy), exp(mod_7$mu_xy),
                              mod_7$omega))
...
reds = tibble(Parameter, Estimative = exp(mod_7$a))
...
st = tibble(Parameter, 
            Estimative = c(mod_7$eta, mod_7$rho, mod_7$kappa))
