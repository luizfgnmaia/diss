...
mod_11 = list(alpha = as.vector(c(solution$getValue(alpha))),
             ...
             duration = duration)
names(mod_11$alpha) = times$Time
names(mod_11$beta) = times$Time
names(mod_11$omega) = c("goal", "red", "value")
names(mod_11$a) = c("lambda", "mu")

save(mod_11, file = "2015-2020/data/mod_11.RData")
