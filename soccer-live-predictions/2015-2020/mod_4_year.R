...
load("2015-2020/data/input_mod_4_year.RData")
...
mod_4_year = list(alpha = as.vector(c(solution$getValue(alpha))),
                   ...
                   duration = duration)
names(mod_4_year$alpha) = times$Time
names(mod_4_year$beta) = times$Time
names(mod_4_year$omega) = c("goal", "red", "goal^2")

save(mod_4_year, file = "2015-2020/data/mod_4_year.RData")
