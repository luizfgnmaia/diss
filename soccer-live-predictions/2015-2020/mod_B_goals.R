...
mod_B_goals = list(alpha = as.vector(c(solution$getValue(alpha))),
                    ...
                    duration = duration)
names(mod_B_goals$alpha) = times$Time
names(mod_B_goals$beta) = times$Time

save(mod_B_goals, file = "2015-2020/data/mod_B_goals.RData")
