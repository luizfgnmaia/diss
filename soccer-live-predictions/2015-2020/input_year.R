...
results = results %>%
  arrange(Date, Match) %>%
  mutate(Home_Team = paste(Season, Home_Team),
         Away_Team = paste(Season, Away_Team))
...
results = results %>%
  ...
  rename(x = Score_Home,
         y = Score_Away) %>%
  mutate(k = 1:nrow(.)) %>%
  select(k, i, j, x, y, Date, Match, Season, ind)
...
times$Time[21] = "2016 América-MG"
times$Time[21] = "2016 América-MG"

times$Time[1] = "2015 Athletico-PR"
times$Time[22] = "2016 Athletico-PR"
times$Time[41] = "2017 Athletico-PR"
times$Time[62] = "2018 Athletico-PR"
times$Time[81] = "2019 Athletico-PR"
times$Time[101] = "2020 Athletico-PR"

times$Time[42] = "2017 Atlético-GO"
times$Time[102] = "2020 Atlético-GO"

times$Time[2] = "2015 Atlético-MG"
times$Time[23] = "2016 Atlético-MG"
times$Time[43] = "2017 Atlético-MG"
times$Time[63] = "2018 Atlético-MG"
times$Time[82] = "2019 Atlético-MG"
times$Time[103] = "2020 Atlético-MG"

tib1 = tibble(Season = results$Season, Date = results$Date, 
              Match = results$Match, Ind = results$ind,
...
tib2 = tibble(Season = results$Season, Date = results$Date, 
              Match = results$Match, Ind = results$ind,
...
tib1s = tibble(Season = results$Season, Date = results$Date, 
               Match = results$Match, Ind = results$ind,
...
tib2s = tibble(Season = results$Season, Date = results$Date, 
               Match = results$Match, Ind = results$ind,
...
save.image("2015-2020/data/input_year.RData")
