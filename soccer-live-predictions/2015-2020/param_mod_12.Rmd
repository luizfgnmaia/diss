---
title: "Parameters 2015-2020 model 12"
output: pdf_document
---
...
\item $v_i$: log of the value of the home team's starting roster in euros;
\item $v_j$: log of the value of the away team's starting roster in euros;
...
load("data/mod_12.RData")
```

```{r}
alphas_betas = tibble(Team = times$Time,
                alpha = exp(mod_12$alpha),
                beta = exp(mod_12$beta))
...
reds = tibble(Parameter, Estimative = exp(mod_12$a))
...
st = tibble(Parameter, 
            Estimative = c(mod_12$eta, mod_12$rho, mod_12$kappa))
