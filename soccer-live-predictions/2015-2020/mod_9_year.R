...
load("2015-2020/data/input_mod_9_year.RData")
...
mod_9_year = list(alpha = as.vector(c(solution$getValue(alpha))),
                   ...
                   duration = duration)
names(mod_9_year$alpha) = times$Time
names(mod_9_year$beta) = times$Time
names(mod_9_year$omega_xy) = c("ahead", "behind")
names(mod_9_year$omega) = c("red", "value")

save(mod_9_year, file = "2015-2020/data/mod_9_year.RData")
