...
mod_7 = list(alpha = as.vector(c(solution$getValue(alpha))),
             ...
             duration = duration)
names(mod_7$alpha) = times$Time
names(mod_7$beta) = times$Time
names(mod_7$lambda_xy) = c("lambda_10", "lambda_01")
names(mod_7$mu_xy) = c("mu_10", "mu_01")
names(mod_7$omega) = "red"
names(mod_7$a) = c("lambda", "mu")

save(mod_7, file = "2015-2020/data/mod_7.RData")
