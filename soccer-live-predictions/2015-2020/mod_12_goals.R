...
mod_12_goals = list(alpha = as.vector(c(solution$getValue(alpha))),
              ...
              duration = duration)
names(mod_12_goals$alpha) = times$Time
names(mod_12_goals$beta) = times$Time
names(mod_12_goals$omega) = c("goal", "red", "value")

save(mod_12_goals, file = "2015-2020/data/mod_12_goals.RData")
