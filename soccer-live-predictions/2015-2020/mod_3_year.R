...
mod_3_year = list(alpha = as.vector(c(solution$getValue(alpha))),
                   ...
                   duration = duration)
names(mod_3_year$alpha) = times$Time
names(mod_3_year$beta) = times$Time
names(mod_3_year$omega) = c("goal", "red")

save(mod_3_year, file = "2015-2020/data/mod_3_year.RData")
