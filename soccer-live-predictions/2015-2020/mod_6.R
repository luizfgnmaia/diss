...
mod_6 = list(alpha = as.vector(c(solution$getValue(alpha))),
             ...
             duration = duration)
names(mod_6$alpha) = times$Time
names(mod_6$beta) = times$Time
names(mod_6$lambda_xy) = c("lambda_10", "lambda_20", "lambda_01", "lambda_02")
names(mod_6$mu_xy) = c("mu_10", "mu_20", "mu_01", "mu_02")
names(mod_6$omega) = "red"
names(mod_6$a) = c("lambda", "mu")

save(mod_6, file = "2015-2020/data/mod_6.RData")
