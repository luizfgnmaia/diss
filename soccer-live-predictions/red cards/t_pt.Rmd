...
load("~/GitHub/soccer-live-predictions/soccer-live-predictions/2015-2020/data/input.RData")
```
...
p = home %>%
  ...
  xlab("Minuto") +
  ylab("Taxa")
ggsave(filename = "reds_mandante.png",
...
p = away %>%
  ...
  xlab("Minuto") +
  ylab("Taxa")
ggsave(filename = "reds_visitante.png",
       plot = p, width = 10, height = 5, dpi = 1000)
```
