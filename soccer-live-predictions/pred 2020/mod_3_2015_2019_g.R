...
load("2015-2019/data/mod_3.RData")
...
for(k in 2:length(dates)) {
  ...
  mod_3_2015_2019_g[[k]] = m3
  print(paste0(round(100*k/length(dates), 2), "%"))
}
names(mod_3_2015_2019_g) = dates

save(mod_3_2015_2019_g, file = "pred 2020/data/mod_3_2015_2019_g.RData")