...
```{r}
all = tibble(RPS = apply(HDA[,c(189:224)], 2, EnvStats::geoMean),
...
```{r}
first_100 = tibble(RPS = apply(HDA[c(1:100), c(189:224)], 2, EnvStats::geoMean),
                   Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 6)),
                   Model = factor(c(rep("0", 6), 
                                    rep("3", 6),
                                    rep("3 (2019)", 6),
...
```{r}
first_200 = tibble(RPS = apply(HDA[c(1:200), c(189:224)], 2, EnvStats::geoMean),
                   Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 6)),
                   Model = factor(c(rep("0", 6), 
                                    rep("3", 6),
                                    rep("3 (2019)", 6),
...
```{r}
last_200 = tibble(RPS = apply(HDA[c(134:333), c(189:224)], 2, EnvStats::geoMean),
                  Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 6)),
                  Model = factor(c(rep("0", 6), 
                                   rep("3", 6),
                                   rep("3 (2019)", 6),
...
```{r}
last_100 = tibble(RPS = apply(HDA[c(234:333), c(189:224)], 2, EnvStats::geoMean),
                  Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 6)),
                  Model = factor(c(rep("0", 6), 
                                   rep("3", 6),
                                   rep("3 (2019)", 6),
...
all_reds = tibble(RPS = apply(HDA_reds[,c(189:224)], 2, EnvStats::geoMean),
                  Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 6)),
                  Model = factor(c(rep("0", 6), 
                                   rep("3", 6),
                                   rep("3 (2019)", 6),
