...
```
```{r}
HDA2[which(HDA2 == 0, arr.ind = TRUE)] = 10^-5 # pra não ter NA (tinha em dois casos)
```

```{r}
all = tibble(GeoMean = apply(HDA2[,c(255:290)], 2, EnvStats::geoMean),
...
```{r}
first_100 = tibble(GeoMean = apply(HDA2[c(1:100), c(255:290)], 2, EnvStats::geoMean),
                   Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 6)),
                   Model = factor(c(rep("0", 6), 
                                    rep("3", 6),
                                    rep("3 (2019)", 6),
...
```{r}
first_200 = tibble(GeoMean = apply(HDA2[c(1:200), c(255:290)], 2, EnvStats::geoMean),
                   Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 6)),
                   Model = factor(c(rep("0", 6), 
                                    rep("3", 6),
                                    rep("3 (2019)", 6),
...
```{r}
last_200 = tibble(GeoMean = apply(HDA2[c(134:333), c(255:290)], 2, EnvStats::geoMean),
                  Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 6)),
                  Model = factor(c(rep("0", 6), 
                                   rep("3", 6),
                                   rep("3 (2019)", 6),
...
```{r}
last_100 = tibble(GeoMean = apply(HDA2[c(234:333), c(255:290)], 2, EnvStats::geoMean),
                  Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 6)),
                  Model = factor(c(rep("0", 6), 
                                   rep("3", 6),
                                   rep("3 (2019)", 6),
...
all_reds = tibble(GeoMean = apply(HDA2_reds[,c(255:290)], 2, EnvStats::geoMean),
                  Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 6)),
                  Model = factor(c(rep("0", 6), 
                                   rep("3", 6),
                                   rep("3 (2019)", 6),
