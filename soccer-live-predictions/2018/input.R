...
# H1s, H2s, A1s, A2s (dummies para os cartões vermelhos) (se existirem dois cartões para um mesmo time no mesmo minuto, recebe valor 2 mas isso não aconteceu em 2018)
