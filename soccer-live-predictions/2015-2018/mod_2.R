...
load("2015-2018/data/input_mod_2.RData")
...
names(mod_2$omega) = c("lambda_x-y", "mu_y-x", "lambda_ys-xs", "mu_xs-ys")
names(mod_2$a) = c("lambda", "mu")

save(mod_2, file = "2015-2018/data/mod_2.RData")
