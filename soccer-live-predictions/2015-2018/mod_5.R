...
load("2015-2018/data/input.RData")
load("2015-2018/data/input_mod_5.RData")
...
mod_5 = list(alpha = as.vector(c(solution$getValue(alpha))),
             ...
             duration = duration)
names(mod_5$alpha) = times$Time
names(mod_5$beta) = times$Time
names(mod_5$lambda_xy) = c("lambda_10", "lambda_01", "lambda_11", "lambda_22", "lambda_21", "lambda_12")
names(mod_5$mu_xy) = c("mu_10", "mu_01", "mu_11", "mu_22", "mu_21", "mu_12")
names(mod_5$omega) = "red"
names(mod_5$a) = c("lambda", "mu")

save(mod_5, file = "2015-2018/data/mod_5.RData")
