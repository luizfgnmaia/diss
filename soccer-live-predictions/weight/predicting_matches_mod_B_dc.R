...
source("pred/pred_mod_B.R")
source("pred/input_pred.R")
source("pred/input_value.R")
load("weight/data/mod_B_dc.RData")
...
for(i in 1:length(ind)) {
  ...
  lst$pred_0 = pred_mod_B(mod_B = mod_B[[lst$Match$Date]], 
                           n = n_pred, 
  ...
  lst$pred_15 = pred_mod_B(mod_B = mod_B[[lst$Match$Date]], 
                            n = n_pred, 
                            home_team = lst$Match$Home_Team, 
                            away_team = lst$Match$Away_Team,
  ...
  lst$pred_30 = pred_mod_B(mod_B = mod_B[[lst$Match$Date]], 
                            n = n_pred, 
                            home_team = lst$Match$Home_Team, 
                            away_team = lst$Match$Away_Team,
  ...
  lst$pred_45 = pred_mod_B(mod_B = mod_B[[lst$Match$Date]], 
                            n = n_pred, 
                            home_team = lst$Match$Home_Team, 
                            away_team = lst$Match$Away_Team,
  ...
  lst$pred_60 = pred_mod_B(mod_B = mod_B[[lst$Match$Date]], 
                            n = n_pred, 
                            home_team = lst$Match$Home_Team, 
                            away_team = lst$Match$Away_Team,
  ...
  lst$pred_75 = pred_mod_B(mod_B = mod_B[[lst$Match$Date]], 
                            n = n_pred, 
                            home_team = lst$Match$Home_Team, 
                            away_team = lst$Match$Away_Team,
  ...
  predictions_mod_B_dc[[i]] = lst
  print(paste0(round(100*i/length(ind), 2), "%"))
}
names(predictions_mod_B_dc) = season_match

save(predictions_mod_B_dc, file = "weight/data/predictions_mod_B_dc.RData")
