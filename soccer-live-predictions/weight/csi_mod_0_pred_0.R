...
csi_mod_0_pred_0 <- function(csi, n_pred = 10^5) {
  ...
  HDA$pnk_Result_mod_0_pred_0[which(HDA$pnk_Result_mod_0_pred_0 == 0)] = 1/n_pred
  HDA$pnk_Score_mod_0_pred_0[which(HDA$pnk_Score_mod_0_pred_0 == 0)] = 1/n_pred
