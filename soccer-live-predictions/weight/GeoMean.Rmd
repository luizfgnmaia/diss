...
```{r}
results_10 = tibble(GeoMean = apply(HDA_10[,c(63:80)], 2, EnvStats::geoMean),
                      Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 3)),
                      Model = factor(c(rep("0", 6), 
                                       rep("3", 6),
                                       rep("8", 6))))
results_10 %>%
  ...
  scale_x_continuous(breaks = c(0, 15, 30, 45, 60, 75)) +
  theme_bw() +
  ggtitle("All predicted matches with score 1-0 lead at minute 45") +
  ylab("Geometric mean for the results")
...
```{r}
scores_10 = tibble(GeoMean = apply(HDA_10[,c(81:98)], 2, EnvStats::geoMean),
                     Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 3)),
                     Model = factor(c(rep("0", 6), 
                                      rep("3", 6),
                                      rep("8", 6))))
...
```{r}
results_01 = tibble(GeoMean = apply(HDA_01[,c(63:80)], 2, EnvStats::geoMean),
                    Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 3)),
                    Model = factor(c(rep("0", 6), 
                                     rep("3", 6),
                                     rep("8", 6))))
...
```{r}
scores_01 = tibble(GeoMean = apply(HDA_01[,c(81:98)], 2, EnvStats::geoMean),
                   Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 3)),
                   Model = factor(c(rep("0", 6), 
                                    rep("3", 6),
                                    rep("8", 6))))
