...
mod_r = list(alpha = as.vector(c(solution$getValue(alpha))),
             ...
             duration = duration)
names(mod_r$alpha) = times$Time
names(mod_r$beta) = times$Time
names(mod_r$a) = c("a_lambda", "a_mu")
names(mod_r$omega) = c("lambda_x", "lambda_y", "mu_x", "mu_y",
                       "lambda_x^s", "lambda_y^s", "mu_x^s", "mu_y^s")

save(mod_r, file = "2020/data/mod_r.RData")
