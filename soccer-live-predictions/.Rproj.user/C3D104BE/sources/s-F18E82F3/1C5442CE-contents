...
load("2018/data/mod_1_dates.RData")
source("2020/pred_mod_1_dates.R")
source("2020/input_pred.R")
...
for(i in 1:length(ind)) {
  ...
  lst$pred_0 = pred_mod_1(mod_1 = mod_1_dates[[lst$Match$Date]], 
                          n = n_pred, 
                          home_team = lst$Match$Home_Team, 
                          away_team = lst$Match$Away_Team)
  
  input_15 = input_pred(ind = ind[i], min = 15)
  lst$pred_15 = pred_mod_1(mod_1 = mod_1_dates[[lst$Match$Date]], 
                          n = n_pred, 
                          home_team = lst$Match$Home_Team, 
                          away_team = lst$Match$Away_Team,
  ...
  lst$pred_30 = pred_mod_1(mod_1 = mod_1_dates[[lst$Match$Date]], 
                           n = n_pred, 
                           home_team = lst$Match$Home_Team, 
                           away_team = lst$Match$Away_Team,
  ...
  lst$pred_45 = pred_mod_1(mod_1 = mod_1_dates[[lst$Match$Date]], 
                           n = n_pred, 
                           home_team = lst$Match$Home_Team, 
                           away_team = lst$Match$Away_Team,
  ...
  lst$pred_60 = pred_mod_1(mod_1 = mod_1_dates[[lst$Match$Date]], 
                           n = n_pred, 
                           home_team = lst$Match$Home_Team, 
                           away_team = lst$Match$Away_Team,
  ...
  lst$pred_75 = pred_mod_1(mod_1 = mod_1_dates[[lst$Match$Date]], 
                           n = n_pred, 
                           home_team = lst$Match$Home_Team, 
                           away_team = lst$Match$Away_Team,
  ...
  predictions_mod_1[[i]] = lst
  print(paste0(round(100*i/length(ind), 2), "%"))
}

names(predictions_mod_1) = match

save(predictions_mod_1, file = "2018/data/predictions_mod_1.RData")
