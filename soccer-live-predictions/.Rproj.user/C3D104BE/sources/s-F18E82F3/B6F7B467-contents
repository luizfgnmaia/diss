...
M1_lambda = M1_lambda[,-c(47:50)]
M1_lambda = cbind(M1_lambda, ys_minus_xs, zero_1)
colnames(M1_lambda)[47:48] = c("ys-xs", "0")

xs_minus_ys = M1_mu[, "xs"] - M1_mu[, "ys"]
M1_mu = M1_mu[,-c(47:50)]
M1_mu = cbind(M1_mu, zero_1, xs_minus_ys)
colnames(M1_mu)[47:48] = c("0", "xs-ys")

ys_minus_xs = M2_lambda[, "ys"] - M2_lambda[, "xs"]
M2_lambda = M2_lambda[,-c(47:50)]
M2_lambda = cbind(M2_lambda, ys_minus_xs, zero_2)
colnames(M2_lambda)[47:48] =c("ys-xs", "0")

xs_minus_ys = M2_mu[, "xs"] - M2_mu[, "ys"]
M2_mu = M2_mu[,-c(47:50)]
M2_mu = cbind(M2_mu, zero_2, xs_minus_ys)
colnames(M2_mu)[47:48] = c("0", "xs-ys")
