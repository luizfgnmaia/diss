...
for(i in 1:length(ind)) {
  ...
  lst$pred_0 = pred_mod_3(mod_3 = mod_3_2015_2019[[lst$Match$Date]], 
                          n = n_pred, 
                          home_team = lst$Match$Home_Team, 
                          away_team = lst$Match$Away_Team)
  
  input_15 = input_pred(ind = ind[i], min = 15)
  lst$pred_15 = pred_mod_3(mod_3 = mod_3_2015_2019[[lst$Match$Date]], 
                           n = n_pred, 
                           home_team = lst$Match$Home_Team, 
                           away_team = lst$Match$Away_Team,
  ...
  lst$pred_30 = pred_mod_3(mod_3 = mod_3_2015_2019[[lst$Match$Date]], 
                           n = n_pred, 
                           home_team = lst$Match$Home_Team, 
                           away_team = lst$Match$Away_Team,
  ...
  lst$pred_45 = pred_mod_3(mod_3 = mod_3_2015_2019[[lst$Match$Date]], 
                           n = n_pred, 
                           home_team = lst$Match$Home_Team, 
                           away_team = lst$Match$Away_Team,
  ...
  lst$pred_60 = pred_mod_3(mod_3 = mod_3_2015_2019[[lst$Match$Date]], 
                           n = n_pred, 
                           home_team = lst$Match$Home_Team, 
                           away_team = lst$Match$Away_Team,
  ...
  lst$pred_75 = pred_mod_3(mod_3 = mod_3_2015_2019[[lst$Match$Date]], 
                           n = n_pred, 
                           home_team = lst$Match$Home_Team, 
                           away_team = lst$Match$Away_Team,
...
save(predictions_mod_3_2015_2019, file = "pred/data/predictions_mod_3_2015_2019.RData")
