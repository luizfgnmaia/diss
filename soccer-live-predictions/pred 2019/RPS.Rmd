...
```{r}
all = tibble(RPS = apply(HDA[,c(45:56)], 2, mean),
...
```{r}
first_100 = tibble(RPS = apply(HDA[c(1:100), c(45:56)], 2, mean),
                   Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 2)),
                   Model = factor(c(rep("0", 6), rep("3 (2015-2019)", 6)),
                                  levels = c("0", "3 (2015-2019)")))  
first_100 %>%
...
```{r}
first_200 = tibble(RPS = apply(HDA[c(1:200), c(45:56)], 2, mean),
                   Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 2)),
                   Model = factor(c(rep("0", 6), rep("3 (2015-2019)", 6)),
                                  levels = c("0", "3 (2015-2019)"))) 
first_200 %>%
...
```{r}
last_200 = tibble(RPS = apply(HDA[c(141:340), c(45:56)], 2, mean),
                  Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 2)),
                  Model = factor(c(rep("0", 6), rep("3 (2015-2019)", 6)),
                                 levels = c("0", "3 (2015-2019)"))) 
last_200 %>%
...
```{r}
last_100 = tibble(RPS = apply(HDA[c(241:340), c(45:56)], 2, mean),
                  Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 2)),
                  Model = factor(c(rep("0", 6), rep("3 (2015-2019)", 6)),
                                 levels = c("0", "3 (2015-2019)"))) 
last_100 %>%
...
all_reds = tibble(RPS = apply(HDA_reds[,c(45:56)], 2, mean),
                  Minute = as.integer(rep(c(0, 15, 30, 45, 60, 75), 2)),
                  Model = factor(c(rep("0", 6), rep("3 (2015-2019)", 6)),
                                 levels = c("0", "3 (2015-2019)"))) 
all_reds %>%
