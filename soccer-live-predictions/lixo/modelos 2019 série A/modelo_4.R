...
log_lik <- function(par) {
  ...
  #       ro_1, ro_2                                    par[44:45]
  #       lambda_10, lambda_01                          par[46:47]
  #       mu_10, mu_01                                  par[48:49]
...
set.seed(1)
#sol = solnp(pars = rep(1, 49), log_lik, LB = rep(0, 49), eqfun = eqfun, eqB = n)
#sol_modelo_4 = sol
#save(sol_modelo_4, file = "sol/sol_modelo_4.RData")

load("sol/sol_modelo_3.RData")
sol = solnp(pars = c(sol_modelo_3$pars, 1, 1, 1, 1), log_lik, LB = rep(0, 49), eqfun = eqfun, eqB = n)
sol_modelo_4b = sol
